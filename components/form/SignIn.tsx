                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <form className="space-y-5" onSubmit={onSignIn}>
                            <div className="animate-element animate-delay-300">
                                ...
                                <GlassInputWrapper>
                                    <input name="email" type="email" placeholder="Entrez votre adresse email" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" />
                                </GlassInputWrapper>
                            </div>
                            ...
                            <div className="animate-element animate-delay-400">
                                ...
                                <GlassInputWrapper>
                                    <div className="relative">
                                        <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Entrez votre mot de passe" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" />
